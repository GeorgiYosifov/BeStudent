...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeStudent.Data.Models.Chat", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeStudent.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeStudent.Data.Models.Payment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeStudent.Data.Models.PaymentAttempt", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BeStudent.Data.Models.Chat", b =>
                {
                    b.HasOne("BeStudent.Data.Models.Semester", "Semester")
                        .WithOne("Chat")
                        .HasForeignKey("BeStudent.Data.Models.Chat", "SemesterId")
            ...
            modelBuilder.Entity("BeStudent.Data.Models.Message", b =>
                {
                    b.HasOne("BeStudent.Data.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId");

                    b.HasOne("BeStudent.Data.Models.ApplicationUser", "User")
                        .WithMany()
